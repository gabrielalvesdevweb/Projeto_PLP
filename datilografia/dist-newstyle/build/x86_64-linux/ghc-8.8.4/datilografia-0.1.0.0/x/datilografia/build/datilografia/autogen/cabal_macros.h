...
/* package datilografia-0.1.0.0 */
#ifndef VERSION_datilografia
#define VERSION_datilografia "0.1.0.0"
#endif /* VERSION_datilografia */
#ifndef MIN_VERSION_datilografia
#define MIN_VERSION_datilografia(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_datilografia */
...
#define CURRENT_COMPONENT_ID "datilografia-0.1.0.0-inplace-datilografia"
